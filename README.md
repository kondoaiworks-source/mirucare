...
16. [http://localhost:3000/admin/rules/more](http://localhost:3000/admin/rules/more) が「監視トラブル」で、行政資料台帳／同期の結果のみであること
17. ルールブック設定に「初回セットアップ」があり、監査項目＋Phase1判定ルールを登録できること
...
7. 市ルールブック／参照URL画面の両方に「自動監視について」の注意文が出ること
8. ヘッダー右上に「ログイン中の事業所」と、設定した表示名が出ること
