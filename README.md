...
6. 下書き画面で案内文の修正・追加・下書きから外す・確定ができること。件数は「国・県／市固有」と出ること。公式資料から出したルールは「公式資料」と出ること
...
10. SQL Editor で `supabase/migrations/20260814120000_compose_origin_city_pdf.sql` と `20260814140000_compose_origin_official.sql` を適用する。「下書きを作る」で標準観点に加え、国・県・市の公式資料からルールが出ること。資料本文が未同期でも標準の観点だけで下書きが作れること。市対応前の下書きが残っているときは破棄して作り直すこと
