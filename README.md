...
6. ルールブックを見るで国・県または自治体と領域を選び、ルール一覧が出ること。資料庫は別ページで国／県／市の公式URLを開き、本文が無いものはリンクを直せること
...
9. ルールブックを見るでルールの保存・追加・停止・削除ができること。資料庫ページで国／県／市の公式URLが開け、本文なしは「リンクを直す」できること
